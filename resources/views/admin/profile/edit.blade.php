...
<div class="mb-3">
    ...
    <img src="{{asset('storage/image/' .$data->picture)}}" width="150" height="150" alt="">
</div>
<div class="mb-3">
...
<div class="mb-3">
    ...
    <textarea name="descriptions" id="descriptions" class="form-control" cols="30" rows="10">{{$data->descriptions}}</textarea>
</div>
<div class="mb-3">
